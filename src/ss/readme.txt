...
1. Update /etc/hosts file to reference your local server for securesphereapi.local
	127.0.0.1 securesphereapi.local
...
<VirtualHost *:80>
    ...
    DocumentRoot "/Users/your.username/Documents/Dev/SE_Apps/securesphereapi"
    ServerName securesphereapi.local
    ErrorLog "/private/var/log/apache2/error_log"
    CustomLog "/private/var/log/apache2/access_log" common
    <Directory "/Users/your.username/Documents/Dev/SE_Apps/securesphereapi.local">
		Options All
		AllowOverride All
		Order allow,deny
		Allow from all
